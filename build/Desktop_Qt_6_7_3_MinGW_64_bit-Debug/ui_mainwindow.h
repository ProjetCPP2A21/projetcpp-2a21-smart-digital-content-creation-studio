...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        stackedWidget_principale->setGeometry(QRect(0, 0, 1431, 701));
        page = new QWidget();
...
"}"));
        ...
        groupBox_recherche_3->setGeometry(QRect(460, 190, 761, 371));
...
"}"));
        ...
        Button_rechercher_2 = new QPushButton(groupBox_recherche_3);
        Button_rechercher_2->setObjectName("Button_rechercher_2");
        Button_rechercher_2->setGeometry(QRect(230, 60, 121, 29));
        Button_tri_2 = new QPushButton(groupBox_recherche_3);
        Button_tri_2->setObjectName("Button_tri_2");
        Button_tri_2->setGeometry(QRect(590, 60, 151, 29));
        ...
        groupBox_6->setGeometry(QRect(10, 80, 441, 491));
        ...
        lineEdit_nom_3 = new QLineEdit(groupBox_6);
        lineEdit_nom_3->setObjectName("lineEdit_nom_3");
        lineEdit_nom_3->setGeometry(QRect(10, 140, 411, 28));
        lineEdit_nom_4 = new QLineEdit(groupBox_6);
        lineEdit_nom_4->setObjectName("lineEdit_nom_4");
        lineEdit_nom_4->setGeometry(QRect(10, 210, 411, 28));
        lineEdit_nom_5 = new QLineEdit(groupBox_6);
        lineEdit_nom_5->setObjectName("lineEdit_nom_5");
        lineEdit_nom_5->setGeometry(QRect(10, 280, 411, 28));
        lineEdit_nom_6 = new QLineEdit(groupBox_6);
        lineEdit_nom_6->setObjectName("lineEdit_nom_6");
        lineEdit_nom_6->setGeometry(QRect(10, 350, 411, 28));
        label_nom_8 = new QLabel(groupBox_6);
        label_nom_8->setObjectName("label_nom_8");
        label_nom_8->setGeometry(QRect(10, 390, 211, 20));
        lineEdit_nom_7 = new QLineEdit(groupBox_6);
        lineEdit_nom_7->setObjectName("lineEdit_nom_7");
        lineEdit_nom_7->setGeometry(QRect(10, 410, 411, 28));
        Button_supprimer_3 = new QPushButton(page_projet);
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Button_rechercher_2->setText(QCoreApplication::translate("MainWindow", "Trier par date", nullptr));
        Button_tri_2->setText(QCoreApplication::translate("MainWindow", "Trier par budget", nullptr));
        ...
        label_nom_8->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:700; color:#55007f;\">Statut:</span></p></body></html>", nullptr));
